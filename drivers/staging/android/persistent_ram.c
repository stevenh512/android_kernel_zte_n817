...
int zte_persistent_ram_init(void)
{
	...
	zte_ram_console_des.size	=	(SZ_1M - 0x4000); //Top 16K is used for RPMB secure channel

	zte_ram_console_buf.start	=	0x1ef00000;
	zte_ram_console_buf.size	=	(SZ_1M - 0x4000); //Top 16K is used for RPMB secure channel;
