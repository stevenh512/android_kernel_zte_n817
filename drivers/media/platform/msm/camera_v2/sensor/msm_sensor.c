...
#endif
static int registed_sensor[2] = {0}; //ZTE_YCM_2014_02_18 
/*
 * Added for engineering mode of camera sensor by ZTE_JIA_20130620 jia.jia
 */
#if defined(CONFIG_MSM_CAMERA_EMODE)
	...
	struct  msm_camera_sensor_board_info *sensordata)
{
	...
	if(!of_property_read_bool(of_node, "qcom,actuator-cam-name" ))
		return 0;
...
// <---
	...
	case CFG_SLAVE_READ_I2C: {
		...
		if (s_ctrl->sensor_i2c_client->cci_client) {
  		...
  		/*
  		 * Added read sensor status modify
  		 *
  		 * by ZTE_YCM_20140328 yi.changming
  		 */
		// --->
		#if 0
			s_ctrl->sensor_i2c_client->client->addr =
				read_slave_addr >> 1;
		#else
			s_ctrl->sensor_i2c_client->client->addr = read_slave_addr;
		#endif
  		// <---
		} else {
