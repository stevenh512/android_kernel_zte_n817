...
static const struct qpnp_vadc_map_pt adcmap_btm_threshold_N817[] = {
	{-300,	1642},
	{-200,	1528},
	{-100,	1406},
	{0,	1262},
...
//zte jiangfeng add
static const struct qpnp_vadc_map_pt adcmap_btm_threshold_0_45[] ={	//0~45 //pullupRs1:77k;Rs2:22.1k
{ -400,	 1724},
{ -390,	 1719},
{ -380,	 1714},
{ -370,	 1709},
...
static struct qpnp_vadc_map_pt adcmap_btm_threshold_0_60[] ={		//0~60
{ -400,	 1760},
{ -390,	 1758},
{ -380,	 1755},
{ -370,	 1752},
	...
	if(batt_hot_threshold == 35	&& batt_cold_threshold == 70)
	{
		//printk("set battery thermal adc scale, adcmap_btm_threshold_0_45\n");
			...
			return qpnp_adc_map_temp_voltage(
					adcmap_btm_threshold_N817,
					ARRAY_SIZE(adcmap_btm_threshold_N817),
					bat_voltage,
