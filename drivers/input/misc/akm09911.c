...
//+++Add for compass dts ZTE_SENSOR_LPZ_20131212
...
//#define AKM_INPUT_DEVICE_NAME	"compass_akm09911"
	...
	int size)
{
	...
	//dev_err(&akm->i2c->dev,"AKECS_GetData enter");
	...
	int size)
{
	...
	//dev_err(&akm->i2c->dev,"AKECS_GetData_Poll enter");
...
//+++Add for compass dts ZTE_SENSOR_LPZ_20131212
#ifdef CONFIG_OF
static struct of_device_id akm09911_compass_match_table[] = {
...
static struct i2c_driver akm_compass_driver = {
	...
	.driver = {
		...
		//+++Add for compass dts ZTE_SENSOR_LPZ_20131212
		#ifdef CONFIG_OF
		.of_match_table = akm09911_compass_match_table,
        #endif
        //---
	},
};
