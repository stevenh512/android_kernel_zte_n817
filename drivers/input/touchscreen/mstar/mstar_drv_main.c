...
static struct kobj_attribute packet_attr = __ATTR(packet, 0644, DrvMainKObjectPacketShow, DrvMainKObjectPacketStore);
...
static struct kobj_attribute gesture_attr = __ATTR(gesture_debug, 0644, DrvMainKObjectGestureDebugShow, DrvMainKObjectGestureDebugStore);
...
static struct kobj_attribute hotknot_value_attr = __ATTR( hotknot_value, 0644, hotknot_value_show, hotknot_value_store );
