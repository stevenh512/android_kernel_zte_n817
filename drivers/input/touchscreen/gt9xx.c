...
static void goodix_ts_work_func(struct work_struct *work)
{
    ...
    if(key_value || pre_key)
    {
		...
		case 4:	//menu
			...
			break;
			#endif
		#if defined(CONFIG_BOARD_EROS)||defined(CONFIG_BOARD_FAERIE)
		case 1:
			input_x  = 120;
            input_y  = 900;
            input_w  = 255;
...
static s32 gtp_init_panel_960(struct goodix_ts_data *ts)
{
    s32 ret = -1;
	...
	u8 cfg_info_group1[] = CTP_CFG_GROUP7;
	u8 cfg_info_group2[] = CTP_CFG_GROUP8;
	u8 cfg_info_group3[] = CTP_CFG_GROUP9;
	u8 cfg_info_group4[] = CTP_CFG_GROUP10;
	u8 cfg_info_group5[] = CTP_CFG_GROUP11;
	u8 cfg_info_group6[] = CTP_CFG_GROUP12;
			  ...
			  void *data)
{
	...
	if(ret>=0){
        ...
        {
 			len += sprintf(page + len, "chip type : %c%c%c\n", 
        ...
        else
        {
        	...
        	{
        		len += sprintf(page + len, "chip type : %c%c%c%c\n", 
