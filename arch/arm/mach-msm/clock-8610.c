...
//	CLK_LOOKUP("core_clk_pvt",              gcc_gp1_clk.c, "2-000e"),
	...
	CLK_LOOKUP("core_clk",                  gcc_gp1_clk.c, "spi4.1"),
/*IRDA CLK ------*/		
...
#else
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0020"),//caidezun modified  20140311 ov9760
#endif
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-006a"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0002"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0042"),//weilanying add 20140815
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0043"),//lvcheng add 20141021 sp0a20
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6-0044"),//weilanying add 20141208 ov2680
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-006c"),//weilanying add 20130927
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0060"),//weilanying add 20130927
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0001"),//weilanying add 20140115 ov8835
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0003"),//caidezun add 20140123 sp2529
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0005"),//weilanying add 20140815
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6-0045"),//lvcheng add 20150428 ov2680
...
#else
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0020"),//caidezun modified  20140311 ov9760
#endif
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0042"),//weilanying add 20140815
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0043"),//lvcheng add 20141021 sp0a20
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0044"),//weilanying add 20141208 ov2680
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-006a"),
	CLK_LOOKUP("cam_clk", mclk1_clk.c, "6-0002"),
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-006c"),  //weilanying add 20130927
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0060"),  //weilanying add 20130927
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0001"),  //weilanying add 20140115 ov8835
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0003"), //caidezun add 20140123 sp2529
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0005"),//weilanying add 20140815
	CLK_LOOKUP("cam_clk", mclk0_clk.c, "6-0045"),//lvcheng add 20150428 ov2680
	/* CSIPHY clocks */
